...
@QuarkusTest
@TestProfile(BuildingGeometryServiceTest.TestConfig.class)
public class BuildingGeometryServiceTest {
    ...
    @Test
    public void createPolygonsForBuildings() throws NodeTreeException, RoadGeometryException {
